...
public class EndecryptUtils {
     ...
     */ 
    public static UserEntity md5Password(String account, String password, int hashIterations){
    ...
    public static void main(String[] args) { 
    	md5Password("admin@webside.com", "123456", 2);

        System.out.println(md5Password("xtttting", "123456", 2));
